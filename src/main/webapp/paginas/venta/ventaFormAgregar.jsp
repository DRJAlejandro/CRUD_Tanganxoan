...
<jsp:include page="../comunes/cabecero.jsp"/>
    ...
    <main>
      <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/ControladorVenta?accion=insertar" method="POST" class="form" id="box" method="POST">
...
<div class="forms__row">
        ...
        <div class="forms__row">
         ...
         <div class="forms__buttons">
            <button class="forms__button forms__button-add" type="button" id="forms__addSale">Agregar</button>
          </div>
        </form>
      </div>
