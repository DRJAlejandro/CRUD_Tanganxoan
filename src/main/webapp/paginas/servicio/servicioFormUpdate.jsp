...
<jsp:include page="../comunes/cabecero.jsp"/>
    ...
    <main>
      <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/ControladorServicio?accion=modificar&idServicio=${servicio.idServicio}" class="form" id="box" method="POST">
        ...
        <div class="forms__row">
         ...
         <div class="forms__buttons">
            <button class="forms__button forms__button-update" type="button" id="forms__addService">Actualizar</button>
          </div>
        </form>
      </div>
