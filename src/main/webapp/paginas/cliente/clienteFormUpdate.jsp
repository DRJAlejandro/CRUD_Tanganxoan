   ...
   <jsp:include page="../comunes/cabecero.jsp"/>
    ...
    <main>
      <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/ControladorCliente?accion=modificar&idCliente=${cliente.idCliente}"  method="POST" class="form" id="box" method="POST">
          <h1 class="form__h1" id="title" >CLIENTE</h1>
        ...
        <div class="forms__row">
          ...
          <div class="forms__buttons">
            <button class="forms__button forms__button-update" type="button" id="forms__addClient">Actualizar</button>
