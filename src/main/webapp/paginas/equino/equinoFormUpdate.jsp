...
<jsp:include page="../comunes/cabecero.jsp"/>
    ...
    <main>
      <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/ControladorEquino?accion=modificar&idEquino=${equino.idEquino}" class="form" id="box" method="POST">
        ...
        <div class="forms__row">
          ...
          <div class="forms__buttons">
            <button class="forms__button forms__button-update" type="button" id="forms__addHorse">Actualizar</button>
          </div>
        </form>
      </div>
